...
alertify.defaults.glossary.title = '';
		...
		$(document).on('click',".inCart", function(){
			...
			console.log($('.presentacion',$prod).val());
			console.log($('.cantidad',$prod).val());
			...
			$.ajax({
				...
				success: function(data){
						alertify.confirm("Product added to Cart.",function (e) {
        if (e) {
            window.top.location.href= "/carts/view";
        }
    }).set('labels', {ok:'Confirm Order', cancel:'Continue shopping'});
				},
